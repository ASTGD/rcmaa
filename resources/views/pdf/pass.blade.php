...
<head>
    ...
    <style>
        ...
        .pass-warning {
            background: #fdf3d7;
            border-top: 1px solid #e0c264;
            border-bottom: 1px solid #e0c264;
            color: #7a5b12;
            font-size: 10px;
            font-weight: bold;
            padding: 8px 15px;
...
<body>
    ...
    <div class="pass-card">
        ...
        {{-- Carried over from the HTML pass this replaced. Without it an
             unverified registration prints a pass indistinguishable from a paid
             one, and the desk has nothing to go on. --}}
        @if ($r->payment_status !== 'verified')
            <div class="pass-warning">
                Payment not yet verified &mdash; please settle this with the committee before the event day.
            </div>
        @endif
