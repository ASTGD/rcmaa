                    ...
                    <form method="POST" action="{{ route('member.link.send') }}" class="mt-4">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <input id="link-email" name="email" type="email" required
                                   class="input min-w-0 flex-1" placeholder="you@example.com">
                    ...
                    <dl class="mt-4 space-y-3 text-sm">
                        <div>
                            ...
                            <dd>
                                ...
                                <span class="block text-xs text-ink-400">{{ config('rcmaa.contact.helpline_hours') }}</span>
                            </dd>
                        </div>
                        <div>
