<x-layout :title="$title" :description="$description">
    <x-page-hero eyebrow="Membership" title="How to Register"
        lead="Join the RCMAA Alumni Network and register for the Grand Reunion in one seamless process — complete one simple form and make your payment via bKash or Bangla QR."
        :breadcrumbs="['How to Register' => null]" />
    ...
    <section class="bg-parchment py-16 md:py-24">
        <div class="container-rc">
            ...
            <div class="grid gap-12 lg:grid-cols-[1fr_1.2fr] lg:gap-20">
                <div>
                    <x-section-heading eyebrow="Eligibility" title="Who can Register" size="sm" />
            ...
            <div class="mt-20">
                ...
                <div class="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-4" data-reveal data-reveal-stagger="0.1">
                    @foreach ([
                            ...
                            ['heart', 'Payment Options and Information', 'Pay using bKash Merchant or Bangla QR (scannable via any MFS like bKash, Nagad, Rocket, Upay, or Bank Apps like CellFin, Citytouch, Astha, DBBL). Please keep your Transaction ID (TrxID) ready to complete the form.'],
