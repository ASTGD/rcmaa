...
<x-layout :title="$title" :description="$description">
    <x-page-hero eyebrow="Our Goal" title="History, aims and objectives"
        lead="How RCMAA began, what it exists to do, and the people leading it." :breadcrumbs="['About' => route('about'), 'Our Goal' => null]" />
    ...
    <section id="journey" data-theme="dark" class="scroll-mt-28 relative overflow-hidden bg-ink-900 py-20 md:py-28">
        ...
        <div
            class="pointer-events-none absolute top-1/3 -right-40 h-[28rem] w-[28rem] rounded-full bg-brass-700/12 blur-[130px]">
        </div>

        <div class="container-rc relative">
            <x-section-heading light eyebrow="আমাদের পথচলা · Our Journey" title="From an idea to Math Nexus 2026" />
            ...
            <ol class="mt-16 space-y-0" data-reveal data-reveal-stagger="0.08">
                @foreach ([
                        ...
                        ['25 January 2026', 'Principal\'s approval', 'Written approval is received from the Principal of Rajshahi College, and 19 or 25 December 2026 is set as the probable reunion date.', 'রাজশাহী কলেজের অধ্যক্ষ মহোদয়ের লিখিত অনুমোদন গ্রহণ করা হয়, এবং ১৯ অথবা ২৫ ডিসেম্বর ২০২৬ তারিখকে সম্ভাব্য পুনর্মিলনের তারিখ হিসেবে নির্ধারণ করা হয়।'],
                        ['Ramadan 2026', 'Iftar Mahfil', 'An Iftar gathering brings together students from batches going back to 1993. The partial convening committee and the full sub-committee for Reunion 2026 are announced there.', 'পবিত্র রমজান মাসে একটি ইফতার মাহফিলের আয়োজন করা হয়, যেখানে ১৯৯৩ সাল পর্যন্ত বিভিন্ন ব্যাচের শিক্ষার্থীরা অংশগ্রহণ করেন। সেখানে Reunion 2026-এর আংশিক আহ্বায়ক কমিটি এবং পূর্ণাঙ্গ উপ-কমিটি ঘোষণা করা হয়।'],
                        ['19 December 2026', 'Math Nexus — Reunion 2026', 'The association\'s largest undertaking: not merely a reunion, but an attempt to build a strong bridge of relationships, memories, experience and cooperation from one generation to the next.', 'RCMAA-এর সবচেয়ে বড় উদ্যোগ হলো Math Nexus — RCMAA Reunion 2026। এটি শুধুমাত্র একটি পুনর্মিলনী নয়, বরং এক প্রজন্ম থেকে পরবর্তী প্রজন্মের মধ্যে সম্পর্ক, স্মৃতি, অভিজ্ঞতা ও সহযোগিতার একটি শক্তিশালী সেতুবন্ধন গড়ে তোলার একটি প্রচেষ্টা।'],
            ...
            <div class="mt-14 grid gap-x-14 gap-y-9 lg:grid-cols-2">
                @foreach ([
                    ...
                    <article class="flex gap-5 border-t border-ink-900/10 pt-7" data-reveal>
                        <span
                            class="heading-display flex-none text-3xl text-brass-500">{{ str_pad($i + 1, 2, '0', STR_PAD_LEFT) }}</span>
                        <div>
    ...
    <section class="bg-parchment py-20 md:py-28">
        <div class="container-rc">
            <x-section-heading eyebrow="আহ্বায়ক ও সদস্য সচিব · Leadership" title="Convenor and Member Secretary" />
            ...
            <div class="mt-14 grid gap-6 md:grid-cols-2" data-reveal data-reveal-stagger="0.12">
                @foreach ([
                    ...
                    <article class="card card-hover flex flex-col gap-6 p-6 sm:flex-row sm:items-start" data-reveal-item>
                        <img src="{{ Storage::disk('public')->url("committee/{$slug}.png") }}" alt="{{ $name }}"
                            loading="lazy" class="h-32 w-28 flex-none rounded-xl bg-ink-900 object-cover object-top">
            ...
            <p class="mt-8 text-center text-sm text-ink-400" data-reveal>
                <a href="{{ route('committee') }}"
                    class="text-brass-700 underline underline-offset-4 transition hover:text-ink-950">
